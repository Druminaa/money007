  ...
  const addProgress = async (goalId: string, amount: number) => {
    ...
    if (goal) {
      ...
      try {
        ...
        toast.success(completed ? 'Goal completed! 🎉' : 'Progress added!')
      } catch (error) {
        // Error handled by hook
      }
    }
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 relative overflow-hidden ${
                      goal.completed ? 'ring-2 ring-green-400' : ''
                    }`}
                  >
                    {/* Background Pattern */}
                    <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${categoryInfo.color} opacity-10 rounded-full -translate-y-16 translate-x-16`} />
                    ...
                    <motion.div
                      ...
                      className={`absolute -top-2 -right-2 w-12 h-12 ${achievement.bg} rounded-full flex items-center justify-center shadow-lg`}
                    >
                    ...
                    <div className="flex items-center justify-center mb-6">
                      <div className="relative">
                        <svg className="w-28 h-28 transform -rotate-90" viewBox="0 0 36 36">
                          ...
                          />
                          <defs>
                            <linearGradient id={`gradient-goal-${index}`} x1="0%" y1="0%" x2="100%" y2="0%">
                              <stop offset="0%" stopColor={goal.completed ? '#10b981' : '#ec4899'} />
                              <stop offset="100%" stopColor={goal.completed ? '#059669' : '#f97316'} />
                            </linearGradient>
                          </defs>
                        </svg>
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <div className="grid grid-cols-3 gap-2">
                          <button
                            ...
                            className={`px-3 py-2 bg-gradient-to-r ${categoryInfo.color} bg-opacity-20 text-gray-700 rounded-lg text-sm hover:bg-opacity-30 transition-all duration-200 font-medium`}
                          >
                            +₹500
                          </button>
                          <button
                    ...
                    {goal.completed && (
                      ...
                      >
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          className="bg-gradient-to-r from-pink-500 to-orange-600 text-white px-4 py-2 rounded-lg text-sm shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-2 mx-auto"
                        >
